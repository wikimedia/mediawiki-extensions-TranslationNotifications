...
Ви отримали цього листа, тому що на {{SITENAME}} ви зареєструвалися як перекладач на такі мови: $2.
...
Є нова сторінка для перекладу: [[$4]]. Будь ласка, перекладіть її тут:
$5
...
Ви отримуєте ці повідомлення електронною поштою, бо ви підписалися на отримання повідомлень щодо перекладу на {{SITENAME}}. Щоб відписатися або змінити параметри сповіщення про переклади, будь ласка, відвідайте <$5>',
	...
	'logentry-translationnotifications-sent' => '$1 {{GENDER:$2|надіслав|надіслала}} сповіщення про сторінки до перекладу ($3 мовами $4) із кінцевим терміном $5 та пріоритетом $6. Вдало надіслано {{PLURAL:$7|$7 одержувачу|$7 одержувачам}}, невдало - {{PLURAL:$8|$8 одежувачу|$8 одержувачам}}, {{PLURAL:$9|$9 одержувача|$9 одержувачів}} було пропущено.',
