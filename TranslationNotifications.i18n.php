...
* $1 - date, or the message {{msg-mw|Translationnotifications-nodeadline}}',
	'logentry-notifytranslators-sent' => '{{logentry}}
...
Каардынатары перакладаў {{GRAMMAR:родны|{{SITENAME}}}}', # Fuzzy
	...
	'logentry-translationnotifications-sent' => '$1 {{GENDER:$2|апавясьціў|апавясьціла}} пра пераклад старонкі «$3»; мовы: $4; тэрмін: $5; прыярытэт: $6; даслана {{PLURAL:$7|1=аднаму адрасату|$7 адрасатам}}, няўдала даслана {{PLURAL:$8|1=аднаму адрасату|$8 адрасатам}}, не даслана {{PLURAL:$9|1=аднаму адрасату|$9 адрасатам}}', # Fuzzy
 ...
 */
$messages['ce'] = array(
	'translationnotifications-username' => 'Декъашхочун цӀе:',
...
$messages['cy'] = array(
	...
	'translationnotifications-info' => 'Manylion y defnyddiwr',
	'translationnotifications-username' => "Enw'r defnyddiwr:",
	'translationnotifications-emailstatus' => 'Statws ebostio:',
	...
	'translationnotifications-contact' => 'Hoff ddulliau cysylltu',
	'translationnotifications-cmethod-email' => 'Ebost',
	'translationnotifications-cmethod-talkpage' => 'Tudalen sgwrs',
	'translationnotifications-cmethod-talkpage-elsewhere' => 'Tudalen sgwrs ar wici arall',
	'translationnotifications-cmethod-feed' => 'Porthiant',
	'translationnotifications-frequency' => 'Amlder negeseuon',
	'translationnotifications-freq-always' => "Pan fydd rhywbeth newydd i'w gyfieithu",
	'translationnotifications-freq-week' => 'Unwaith yr wythnos ar y mwyaf',
	'translationnotifications-freq-month' => 'Unwaith y mis ar y mwyaf',
	'translationnotifications-freq-weekly' => 'Crynhoad wythnosol',
	'translationnotifications-freq-monthly' => 'Crynhoad misol',
...
$messages['fa'] = array(
	...
	'translationnotifications-emailstatus' => 'وضعیت رایانامه:',
	'translationnotifications-email-confirmed' => 'نشانی رایانامه تأیید شده‌است',
	...
	'translationnotifications-email-unconfirmed' => 'نشانی رایانامه شما تأیید نشده‌است. $1',
	...
	'translationnotifications-cmethod-email' => 'رایانامه',
...
N!این رایانامه را به این سبب دریافت می‌کنید که برای دریافت رایانامه‌های مربوط به ترجمه در {{SITENAME}} نام‌نویسی کرده‌اید. برای لغو اشتراک یا تغییر ترجیحات آگاه‌سازی‌هایتان لطفاً از <$5> بازدید کنید.',
	...
	'logentry-notifytranslators-sent' => '$1  اطلاع‌رسانی در مورد ترجمهٔ صفحهٔ  $3  {{GENDER:$2|ارسال کرد}};  {{PLURAL:$10| زبان|زبان}}:  $4 ; آخرین مهلت:  $5 ؛ اولویت:  $6 ; فرستاده شده به  {{PLURAL:$7| یک گیرنده|$7 گیرنده}}، شکست‌خورده برای  {{PLURAL:$8|یک گیرنده| $8  گیرنده}}، رهاشده برای  {{PLURAL:$9|یک گیرنده|$9  گیرنده}}',
...
$messages['fr'] = array(
	...
	'translationnotifications-desc' => 'Permet aux traducteurs de s’abonner aux notifications de traduction',
	'translationnotifications-info' => 'Informations sur l’utilisateur',
	...
	'translationnotifications-submit-ok' => 'Des notifications ont été ajoutées à une file d’attente et seront livrées par une tâche d’arrière-plan.',
...
{{SITENAME}}에 번역에 대해 이메일을 받도록 가입했기 때문에 이 이메일을 받았습니다. 구독을 취소하거나 번역에 대한 사용자 알림 환경 설정을 바꾸려면 <$5>로 방문하세요.',
	...
	'logentry-translationnotifications-sent' => '$1 사용자가 $3 번역 문서에 대한 알림을 {{GENDER:$2|보냈습니다}}. {{PLURAL:$10|언어}}: $4; 마감일: $5; 중요도: $6; {{PLURAL:$7|받는 사람 한 명|받는 사람 $7명}}한테 보냄, {{PLURAL:$8|받는 사람 한 명|받는 사람 $8명}}한테 보내기 실패, {{PLURAL:$9|받는 사람 한 명|받는 사람 $9명}}한테 보내기 생략',
...
$messages['ml'] = array(
	...
	'translationnotifications-cmethod-talkpage' => 'സം‌വാദത്താൾ',
...
{{SITENAME}} സംരംഭത്തിൽ പരിഭാഷയ്ക്കായി പേരുചേർത്തിട്ടുള്ളതിനാലാണ് താങ്കൾക്ക് ഈ ഇമെയിൽ അയയ്ക്കുന്നതു്. ഈ അറിയിപ്പുകൾ വേണ്ടെങ്കിലോ അറിയിക്കേണ്ട  രീതി മാറ്റണമെങ്കിലോ $8 ദയവായി സന്ദർശിക്കുക.', # Fuzzy
	...
	'translationnotifications-sent-title' => 'പരിഭാഷാ അറിയിപ്പ് അയച്ചിരിക്കുന്നു.',
	'translationnotifications-sent-body' => 'പരിഭാഷാ അറിയിപ്പ് അയച്ചിരിക്കുന്നു.',
	'translationnotifications-log-alllanguages' => 'എല്ലാ ഭാഷകളും',
	'translationnotifications-nodeadline' => 'ഒന്നുമില്ല',
	'translationnotifications-signup-legal' => '{{SITENAME}} എന്ന വിക്കിയെക്കുറിച്ച് താങ്കൾക്ക് താത്പര്യമുണ്ടായേക്കാവുന്ന വിവരങ്ങൾ സംബന്ധിച്ച് ഞങ്ങൾക്കു് താങ്കളെ ബന്ധപ്പെടാമെന്നു താങ്കൾ സമ്മതിയ്ക്കുന്നു. താങ്കൾ തരുന്ന വിവരങ്ങൾ [[{{MediaWiki:Privacypage}}|സ്വകാര്യതാനയം]] അനുസരിച്ച് ആയിരിക്കും  എന്നും താങ്കൾ സമ്മതിക്കുന്നു.',
);
...
Вы получили это письмо, так как зарегистрировались на сайте «{{SITENAME}}» в качестве переводчика на {{PLURAL:$9|1=следующий язык|следующие языки}}: $2.
...
Мы были бы очень признательны за вашу помощь. Переводчики вроде вас помогают сделать сайт «{{SITENAME}}» подлинно многоязычным сообществом.

Спасибо!
Координаторы переводов сайта «{{SITENAME}}»

----

Вы получили это сообщение, поскольку подписались на получение сообщений, связанных с переводами для сайта «{{SITENAME}}». Чтобы отписаться или изменить свои настройки уведомлений о переводах, перейдите по ссылке $8.',
	'translationnotifications-talkpage-body' => 'Здравствуйте, $2!

Вы получили это письмо, так как {{GENDER:$1|зарегистрировались}} на сайте «{{SITENAME}}» в качестве переводчика на {{PLURAL:$9|1=следующий язык|следующие языки}}: $3.
...
Имеется $3 {{PLURAL:$3|страница|страниц|страницы}} для перевода. Подробности — ниже.
...
Вы получили это сообщение, поскольку подписались на получение сообщений, связанных с переводами для сайта «{{SITENAME}}». Чтобы отписаться или изменить свои настройки уведомлений о переводах, перейдите по ссылке <$5>.',
	...
	'logentry-notifytranslators-sent' => '$1 {{GENDER:$2|отправил|отправила}} уведомление о переводе страницы $3; {{PLURAL:$10|1=язык|языки}}: $4; крайний срок: $5; приоритет: $6; послано {{PLURAL:$7|$7 адресату|$7 адресатам|1=одному адресату}}, неудачно для {{PLURAL:$8|$8 адресата|$8 адресатов|1=одного адресата}}, пропущено для {{PLURAL:$9|$9 адресата|$9 адресатов|1=одного адресата}}',
...
$messages['sco'] = array(
	...
	'translationnotifications-email-disablemail' => "Yer wabmail address haes been confirmed, but in [[Special:Preferences|yer preferences]] ye'v asked tae receeve naw wabmail.",
	'translationnotifications-email-unconfirmed' => 'Yer wab-mail address haesna been confirmed. $1',
	'translationnotifications-email-notset' => "Ye'v na gien ae wab-mail address. Ye can dae that in yer [[Special:Preferences|preeferances]].",
...
$messages['te'] = array(
	...
	'translationnotifications-email-confirmed' => 'మీ ఈమెయిలు చిరునామా ధృవీకరించబడింది',
	'translationnotifications-email-disablemail' => 'మీ ఈమెయిలు చిరునామా ధృవీకరించబడింది. కానీ ఈమెయిలు పంపించవద్దని మీరు [[Special:Preferences|మీ అభిరుచులలో]] చెప్పారు.',
	'translationnotifications-email-unconfirmed' => 'మీ ఈమెయిలు చిరునామా ధృవీకరించబడలేదు. $1',
	'translationnotifications-email-notset' => 'మీరు ఈమెయిలు చిరునామా ఇవ్వలేదు. దాన్ని మీరు మీ [[Special:Preferences|అభిరుచులలో]] ఇవ్వవచ్చు.',
	'translationnotifications-languages' => 'భాషలు',
	'translationnotifications-lang' => 'భాష #$1',
	'translationnotifications-nolang' => 'భాషను ఎంచుకోండి',
	'translationnotifications-cmethod-email' => 'ఈమెయిలు',
	'translationnotifications-cmethod-talkpage' => 'చర్చా పేజీ',
	'translationnotifications-cmethod-talkpage-elsewhere' => 'ఇతర వికీలోని చర్చా పేజీ',
	'translationnotifications-cmethod-feed' => 'వడ్డన',
	'translationnotifications-frequency' => 'సంప్రదించే తరచుదనం',
	'translationnotifications-freq-always' => 'అనువదించేందుకు కొత్తదేమైనా ఉన్నపుడు',
	'translationnotifications-freq-week' => 'గరిష్ఠంగా వారానికి ఒకసారి',
	'translationnotifications-freq-month' => 'గరిష్ఠంగా నెలకు ఒకసారి',
	'translationnotifications-freq-weekly' => 'వారపు సంగ్రహం',
	'translationnotifications-freq-monthly' => 'నెలవారీ సంగ్రహం',
	'translationnotifications-submit' => 'అమర్పులను తాజాకరించు',
	'translationnotifications-signup-success' => 'మీ అనువాద గమనింపు అభిరుచులను భద్రపరచాం.',
	'notifytranslators' => 'అనువాదకులకు గమనింపు',
	'translationnotifications-submit-ok' => 'గమనింపులను ఓ క్యూలో పెట్టాం. వీటిని నేపథ్యంలో నడిచే ఒక వ్యవస్థ పంపించేస్తుంది.',
	'translationnotifications-send-notification-button' => 'అనువాదకులకు గమనింపు పంపించు',
	'translationnotifications-preview-notification-button' => 'గమనింపు మునుజూపు',
	'translationnotifications-languages-to-notify-label' => 'ఏ భాషలకు గమనింపు పంపాలి:',
	'translationnotifications-priority' => 'ప్రాధాన్యత:',
	'translationnotifications-priority-high' => 'ఎక్కువ',
	'translationnotifications-priority-medium' => 'మధ్యస్థం',
	'translationnotifications-priority-low' => 'తక్కువ',
	'translationnotifications-priority-unset' => '(సెట్ చెయ్యవద్దు)',
	'translationnotifications-translatablepage-title' => 'అనువదించదగ్గ పేజీ పేరు:',
	'translationnotifications-error-no-translatable-pages' => 'ఈ వికీలో అనువదించదగ్గ పేజీల్లేవు.',
	'translationnotifications-email-subject' => '$1 పేజీని అనువదించ గలరు',
	'translationnotifications-notification-url-listitem' => '$1 లోకి అనువదించండి',
	'translationnotifications-digestemail-subject' => '{{SITENAME}} నుండి అనువాద అభ్యర్ధనల సంగ్రహ ఇమెయిలు',
	'translationnotifications-digestemail-notification-line' => '$1 న $2, "$3" ను అనువదించడం కోసం గుర్తు పెట్టారు. మీరు దాన్ని $4 వద్ద అనువదించవచ్చు',
	'translationnotifications-edit-summary' => 'అనువాద గమనింపు: $1',
	'translationnotifications-email-priority' => 'ఈ పేజీ యొక్క ప్రాధాన్యత $1.',
	'translationnotifications-email-deadline' => 'ఈ పేజీని అనువదించేందుకు గడువు తేదీ $1.',
	'log-name-notifytranslators' => 'అనువాద గమనింపులు',
	'log-description-notifytranslators' => 'అనువదించదగ్గ పేజీల గురించిన గమనింపుల లాగ్‍ను అనువాదకులకు పంపించాం',
	'translationnotifications-sent-title' => 'అనువాద గమనింపును పంపించాం',
	'translationnotifications-sent-body' => 'అనువాద గమనింపును పంపించాం.',
	'translationnotifications-log-alllanguages' => 'అన్ని భాషలు',
	'translationnotifications-nodeadline' => 'ఏమీలేదు',
	'translationnotifications-generic-languages' => '&lt;భాషలు>',
);
...
Ви отримуєте ці повідомлення електронною поштою, бо ви підписалися на отримання повідомлень щодо перекладу на {{SITENAME}}. Щоб відписатися або змінити параметри сповіщення про переклади, будь ласка, відвідайте <$5>',
	...
	'logentry-translationnotifications-sent' => '$1 {{GENDER:$2|надіслав|надіслала}} сповіщення про сторінки до перекладу ($3 {{PLURAL:$10|1=мовою|мовами}} $4) із кінцевим терміном $5 та пріоритетом $6. Вдало надіслано {{PLURAL:$7|1=$7 одержувачу|$7 одержувачам}}, невдало — {{PLURAL:$8|1=$8 одержувачу|$8 одержувачам}}, {{PLURAL:$9|1=$9 одержувача|$9 одержувачів}} було пропущено.',
...
$messages['vi'] = array(
	...
	'translationnotifications-cmethod-feed' => 'Nguồn cấp dữ liệu',
 ...
 */
$messages['yi'] = array(
	'translatorsignup' => 'איבערזעצער אײַנשרײַבן',
	...
	'translationnotifications-cmethod-feed' => 'פיד',
	'translationnotifications-freq-always' => "ווען ס'איז פֿאראן נײַע איבערזעצונגען",
...
איר באקומט דעם ע־פאסט ווייל איר האט זיך אונטערגעשריבן צו באקומען בליצבריוון מיט א שייכות צו איבערזעצונגען ביי  {{SITENAME}}. זיך אומאבאנירן, אדער צו ענדערן  אייער אנזאג פרעפערענצן פאר איבערזעצונגען, זייט אזוי גוט באזוכט <$5>.',
	...
	'logentry-notifytranslators-sent' => '$1 {{GENDER:$2|האט געשיקט}} אן אנזאג וועגן איבערזעצן בלאט $3; {{PLURAL:$10|שפראך|שפראכן}}: $4; טערמין: $5; פריאריטעט: $6; געשיקט מיט דערפאלג צו {{PLURAL:$7|איין באקומער|$7 באקומער}}, דורכגעפאלן פאר {{PLURAL:$8|איין באקומער|$8 באקומער}}, איבערגעהיפט {{PLURAL:$9|איין באקומער|$9 באקומער}}',
	...
	'translationnotifications-generic-languages' => '&lt;שפראכן>',
);
