...
Координаторы переводов {{SITENAME}}', # Fuzzy
...
Вы получили это сообщение, поскольку подписались на получение сообщений, связанных с переводами для {{SITENAME}}. Чтобы отписаться или изменить свои настройки уведомлений о переводах, перейдите по ссылке <$5>.', # Fuzzy
	...
	'logentry-translationnotifications-sent' => '$1 {{GENDER:$2|отправил|отправила}} уведомление о переводе страницы $3; {{PLURAL:$10|1=язык|языки}}: $4; крайний срок: $5; приоритет: $6; послано {{PLURAL:$7|1=одному адресату|$7 адресатам}}, неудачно для {{PLURAL:$8|1=одного адресата|$8 адресатов}}, пропущено для {{PLURAL:$9|1=одного адресата|$9 адресатов}}', # Fuzzy
